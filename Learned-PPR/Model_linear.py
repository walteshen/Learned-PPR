...
class PPR_Transformer(nn.Module):
    def __init__(self, args, dropout=0):
        super(PPR_Transformer, self).__init__()
        ####
        code = args.code
        self.n = code.n
        self.k = code.k
...
if __name__ == "__main__":
    ...
    parser.add_argument("--code_k", type=int, default=30)
    parser.add_argument("--code_n", type=int, default=48)
